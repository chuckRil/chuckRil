<%-- 
    Document   : Content
    Created on : 10 8, 20, 12:00:51 AM
    Author     : Chuck
--%>
...
.pusher
    ...
    <body>
        <header>
            ...
            <a href="Main.jsp" class="header-content">‏‏‎ ‎Home‏‏‏‏‎‏‏‎‏‏‎ ‎‏‏‎ ‎</a>
            <h2 class="header-content2">Content</h2>
        </header>
        
        <section class="index-contentPic1">
                <div class="">
                    <h2></h2>
                </div>
        </section>
        
        <section class="index-contentPic2">
                <div class="">
                    <h2></h2>
                </div>
        </section>
        
        <section class="index-contentPic3">
                <div class="">
                    <h2></h2>
                </div>
        </section>
        
        <section class="index-contentPic4">
                <div class="">
                    <h2></h2>
                </div>
        </section>
