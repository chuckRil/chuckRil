<%-- 
    Document   : About
    Created on : 10 7, 20, 11:56:31 PM
    Author     : Chuck
--%>
...
subheader{
    ...
    <body>
        <header>
            ...
            <a href="Main.jsp" class="header-Aboutme">‏‏‎ ‎Home‏‏‏‏‎‏‏‎‏‏‎ ‎‏‏‎ ‎</a>
            <h2 class="header-Aboutme2">ABOUT ME</h2>
        </header>
        <section class="index-bannerbout">
                <div class="vertical-center">
                    <h2></h2>
                </div>
        </section>
        <section class="index-bannerbout1">
            <div class="vertical-center">
                <ul>
                    <h2>Name: Bryan Dave T. Real</h2>
                    <h2>Age: 19</h2>
                    <h2>Birth Date: October 12, 2000</h2>
                    <h2>Hobby: Photography</h2>
                </ul>
            </div>
        </section>
        
        <section class="index-bannerbout2">
            <div class="vertical-center">
                <ul>
                    <h2></h2>
                </ul>
        ...
        <section class="index-bannerbout3">
            <div class="vertical-center">
                <ul>
                    <h2></h2>
                </ul>
        ...
        <section class="index-bannerbout4">
            <div class="vertical-center">
                <ul>
                    <h2></h2>
                </ul>
